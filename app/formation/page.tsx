    ...
    <main className="bg-[#050814] text-slate-100 site-gutter">
      ...
      <section className="border-b border-slate-800 bg-[#050814] py-12 sm:py-16">
        <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
          ...
          <Reveal delayMs={50}> <p className="mt-6 text-center text-xs text-slate-400 sm:text-sm">
              ...
              <div className="rounded-2xl border border-slate-700 bg-black/40 p-5">
                ...
                <p className="mt-3 text-sm text-slate-200">
                  {rails.formation?.body ||
                    "Three intentional discipleship experiences that most people walk through in their first 12 months:"}
                </p>
                <ul className="mt-3 list-disc space-y-1 pl-5 text-xs text-slate-300 sm:text-sm">
        ...
        <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 grid gap-5 md:grid-cols-3">
            {tracks
              ...
              .map((track) => (
                <Reveal delayMs={100} key={track.id}>
                  <div
